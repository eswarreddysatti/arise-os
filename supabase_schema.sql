...
create table if not exists profiles (
  ...
  career_goal text default 'Cybersecurity Role — 14+ LPA',
  career_deadline date default '2026-12-31',
  career_progress integer default 0 check (career_progress between 0 and 100),
